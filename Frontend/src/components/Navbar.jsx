        ...
        <div className="navbar ">
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block">
              <label className=" px-3 py-1  flex items-center gap-2">
                <input
                  type="text"
                  className="grow outline-none border-b-2 border-gray-500 py-2 rounded-md px-1 mx-5 bg-transparent dark:text-white"
                  placeholder="Search"
                />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 16 16"
                  fill="currentColor"
                  className="w-7 h-7 opacity-70 mx-[-15px]"
                >
                  <path
                    fillRule="evenodd"
